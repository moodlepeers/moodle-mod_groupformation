 ...
 */
	...
	class mod_groupformation_generateGroup	{
		...
		//array aus arrays -> jedes einzelarray steht für eine Gruppe || Inahlt sind die jeweiligen Userids
		private $courseid;
		...
		public function generate($userGroups){
			...
			foreach($userGroups as $group){
				...
				if (groups_get_group_by_name($this->courseid, $name)) {
				...
				$newgroup->courseid = $this->courseid;
				$newgroup->name = $name;
