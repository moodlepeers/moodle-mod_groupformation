...
$string ['questionaire_availability_info_now'] = 'Im Zeitraum vom {$a->start} Uhr bis {$a->end} Uhr ist der Fragebogen freigeschaltet.';
$string ['questionaire_availability_info_until'] = 'Der Fragebogen ist bis {$a->end} Uhr freigeschaltet.';
