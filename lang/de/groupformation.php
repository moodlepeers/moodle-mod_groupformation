...
$string ['knowledge_question'] = 'Wie sch&auml;tzen Sie Ihr pers&ouml;nliches Vorwissen in folgenden Gebieten ein?';
...
$string ['groupname'] = 'Gruppierungsname';
$string ['groupname_help'] = 'Der Gruppierungsname wird als Präfix für die generierten Gruppen genutzt. Das Schema ist <Gruppierungsname>_XXX, wobei XXX für die Nummer der Gruppe steht. ';
$string ['evaluationmethod_description'] = 'Wie bewerten Sie die Arbeit?';
$string ['grades'] = 'Noten';
...
$string ['groupname_error'] = 'Der Name kann maximal 100 Zeichen lang sein.';
...
$string ['questionaire_availability_info_now'] = 'Der Fragebogen ist derzeit offen und kann ausgefüllt werden bis {$a->end} Uhr freigeschaltet.';
$string ['questionaire_availability_info_until'] = 'Der Fragebogen ist derzeit offen und kann ausgefüllt werden bis {$a->end} Uhr freigeschaltet.';
