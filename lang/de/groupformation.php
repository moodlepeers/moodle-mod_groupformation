...
$string ['scenario_groupwork'] = 'Gruppenarbeit';
$string ['scenario_groupwork_description'] = 'Gruppenarbeit in der Teilnehmer/innen über einen längeren Zeitraum intensiv zusammenarbeiten (z.B. Wöchentliche Übungsaufgaben, Durchführung einer Studie, Abgabe eines Berichtes, etc.). Oft können die Aufgaben innerhalb der Gruppe aufgeteilt werden, sodass es von Vorteil ist, wenn sich die Kompetenzen der Gruppenmitglieder gegenseitig ergänzen. Typischerweise wird die gemeinsame Arbeit mit einer Gruppennote für alle Gruppenmitglieder bewertet. Daher geht es bei der Zusammensetzung primär um ähnliche Persönlichkeitseigeneschaften und Teamorientierung der Gruppenmitglieder.';
...
$string ['scenario_groupwork_short'] = 'Vorwissensbereiche heterogen; Teamorientierung und Persönlichkeitsmerkmale homogen';
...
$string ['analysis_status_ga_started'] = 'Die Gruppen werden nach Moodle übernommen. Das kann eine Weile dauern. Kommen Sie zu einem späteren Zeitpunkt zurück um die Ergebnisse einzusehen.';
...
$string ['re-open_questionnaire'] = 'Fragebogen erneut öffnen';
