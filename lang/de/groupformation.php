...
$string ['oneOfBinQuestion'] = 'Es soll eine Auswahlfrage im Fragebogen gestellt werden.';
$string ['oneOfBinAnswers'] = 'Antwortmöglickeiten';
$string ['oneOfBinImportance'] = 'Gewichtung der Auswahlfrage';
$string ['oneOfBinRelation'] = 'Relation der Auswahlfrage';
$string ['homogenous'] = 'Homogen';
$string ['heterogenous'] = 'Heterogen';
$string ['choose_oob_answers'] = 'Wie lautet Ihre Auswahlfrage?';
$string ['add_oob_question'] = 'Bitte formulieren Sie hier Ihre Auswahlfrage (z.B. Welchen Studiengang studierst du?).';
$string ['answers'] = 'Antwortmöglichkeiten:';
$string ['importance'] = 'Gewichtung für Gruppenbildung:';
$string ['choose_oob_importance'] = 'Wählen Sie die Gewichtung der Auswahlfrage für die Gruppenbildung:';
$string ['relation'] = 'Relationstyp:';
$string ['choose_oob_relation'] = 'Wählen Sie die gewünschte Relation der Auswahlfrage für die Gruppenbildung:';
$string ['choose_answer'] = 'Auswahlfrage: Wählen Sie eine der Antwortmöglichkeiten.';
$string ['choose_answers'] = 'Auswahlfrage: Wählen Sie eine oder mehrere Antwortmöglichkeiten.';
$string ['no_oob_question'] = 'Hier wird Ihre Frage stehen.';
$string ['oob_selected_value'] = 'Ausgewählter Wert: ';
$string ['decide_multiselect'] = 'Sollen Mehrfachantworten möglich sein (Standard: Single Choice)?';
$string ['multiselect'] = 'Mehrfachantworten ermöglichen (Multiple Choice)';
$string ['choose_type'] = 'Art der Auswahlfrage';
...
$string ['category_binquestion'] = 'Studiengang';
...
$string ['tabletitle_binquestion'] = 'Auswahlfrage: Wählen Sie eine der Antwortmöglichkeiten.';
$string ['tabletitle_binquestion_multi'] = 'Auswahlfrage: Wählen Sie eine oder mehrere Antwortmöglichkeiten.';
...
<li>
Der/die Kursleiter/in oder Dozent/in sieht meine persönlichen Angaben für die Gruppenformation nicht.
</li>
<li>
Meine Angaben werden am Kursende - spätestens nach {$a->archivedays} Tagen gelöscht.
</li>
<li>
Meine Angaben werden im Rahmen der Studie mittels meines Teilnehmercodes gepaart und dadurch pseudonymisiert. Es ist kein Rückschluss auf Einzelpersonen möglich.
</li>
<li>
Meine Leistungen im Kurs werden unter Verwendung meines Teilnehmercodes ausschließlich zu wissenschaftlichen Zwecken ausgewertet.
</li>
<li>
Ich weiß, dass die Teilnahme an der Studie freiwillig ist und ich die Teilnahme jederzeit ohne Angaben von Gründen beenden kann.
</li>
</ul>';
