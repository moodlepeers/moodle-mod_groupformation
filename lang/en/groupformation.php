...
$string ['privacy:metadata:groupformation_started'] = 'Information about the users\' status for the activity';
$string ['privacy:metadata:groupformation_started:groupformation'] = 'ID of the activity';
$string ['privacy:metadata:groupformation_started:userid'] = 'ID of the user';
$string ['privacy:metadata:groupformation_started:completed'] = 'Flag indicating if user completed the questionnaire';
$string ['privacy:metadata:groupformation_started:timecompleted'] = 'Timestamp of when user completed the questionnaire';
$string ['privacy:metadata:groupformation_started:groupid'] = 'Group ID if A/B grouping is activated for research setup';
$string ['privacy:metadata:groupformation_started:answer_count'] = 'Number of answered questions';
$string ['privacy:metadata:groupformation_started:consent'] = 'Flag indicating if user gave consent (if consent is requested)';
$string ['privacy:metadata:groupformation_started:participantcode'] = 'Participant code of user (if participant code is requested)';
$string ['privacy:metadata:groupformation_started:filtered'] = 'Flag indicating whether user was filtered out during grouping process and was grouped randomly.';
