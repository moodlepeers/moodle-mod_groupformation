...
$string ['analysis_status_info0'] = 'You have to stop the activity before starting the group formation.';
$string ['analysis_status_info1'] = 'You have to start the activity. This way, students can answer the questionnaire.';
