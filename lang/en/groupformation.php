...
$string ['questionaire_availability_info_now'] = 'This questionaire is available from {$a->start} until {$a->end}.';
$string ['questionaire_availability_info_until'] = 'This questionaire is available until {$a->end}.';
$string ['questionaire_availability_info_from'] = 'This questionaire is available on {$a->end}.';
