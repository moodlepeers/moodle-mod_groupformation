...
$string ['questionaire_submit_disabled_teacher'] = '(Submit is disabled because you have the role "Teacher")';
$string ['questionaire_preview'] = '(This is a preview of the questionaire)';
$string ['questionaire_not_available'] = 'The questionaire is not available right now.';
$string ['questionaire_availability_info_future'] = 'It will be available from {$a->start} until {$a->end}.';
$string ['questionaire_availability_info_now'] = 'This questionaire is open and available until {$a->end}.';
$string ['questionaire_availability_info_until'] = 'This questionaire is open and available until {$a->end}.';
$string ['questionaire_availability_info_from'] = 'This questionaire is available on {$a->start}.';
