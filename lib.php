...
*/
	...
	*/
 	...
 	* of the new instance.
 	*
 	* @param object $groupformation An object from the form in mod_form.php
	...
	function groupformation_delete_instance($id) {
		global $DB;
		if (! $groupformation = $DB->get_record('groupformation', array('id' => $id))) {
			return false;
		}
	...
	function groupformation_scale_used($groupformationid, $scaleid) {
		global $DB;
		/* @example */
		if ($scaleid and $DB->record_exists('groupformation', array('id' => $groupformationid, 'grade' => -$scaleid))) {
			return true;
		} else {
			return false;
		}
	...
	function groupformation_scale_used_anywhere($scaleid) {
		global $DB;
		/* @example */
		if ($scaleid and $DB->record_exists('groupformation', array('grade' => -$scaleid))) {
			return true;
		} else {
			return false;
		}
	...
	*
 	...
 	* @param navigation_node $groupformationnode {@link navigation_node}
 	*/
