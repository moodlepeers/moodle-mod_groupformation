...
class mod_groupformation_mod_form extends moodleform_mod {
    ...
    private function generate_html_for_js(&$mform) {
        ...
        if (false) {
            ...
            $mform->addElement('html', $teacherinfo);
            ...
            $mform->addElement('html', '
                    ...
                    . get_string('scenario_projectteams_short', 'groupformation') . '</small></p><p><small>' .
    ...
    <div class="col_m_33">
            ...
            $mform->addElement('html', '    <div class="gf_pad_header">');

            $mform->addElement('html', '        <label class="gf_label" for="id_js_knowledge">');

            $mform->addElement('html', '            <input type="checkbox" id="id_js_knowledge" name="chbKnowledge" value="wantKnowledge" />
                              ');

            $mform->addElement('html', get_string('knowledge_description', 'groupformation') . '');

            $mform->addElement('html', '        </label>');

            $mform->addElement('html', '        <span class="optional">');

            $mform->addElement('html', '        </span>');

            $knowledgehelp = get_string('knowledge_description', 'groupformation');

            $mform->addElement('html', "        <span class='toolt' tooltip='$knowledgehelp'>");
            ...
            $mform->addElement('html', '<div class="gf_pad_content" id="js_knowledgeWrapper">');

            $mform->addElement('html', get_string('knowledge_description_extended', 'groupformation') . '</p> -->
