...
class mod_groupformation_criterion_calculator
{
    ...
    public function get_values_for_users($criterion, $users, $specs = null)
    {
        ...
        foreach ($users as $key => $user) {
            $usersvalues[$user] = $this->$function($user, $specs);
        }
    ...
    public function get_avg_values_for_users($criterion, $groupusers, $usersvalues)
    {
        ...
        if ($groupsize > 0) {
            foreach ($groupusers as $groupuser) {
                ...
                // $uservalues = $this->get_values_for_user($criterion, $groupuser);
            ...
            // var_dump($avgvalues,$groupsize);
        }

        return $avgvalues;
    }

    function compute_z_score($usersvalues)
    {
