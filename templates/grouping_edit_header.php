    ...
    <div class="grid">
        <div class="col_m_75">
            ...
            <div class="selected_memb_info"><span
                    id="memb_counter">0 </span><?php echo get_string('students_selected', 'groupformation'); ?></div>
            <div class="selected_memb_info"><span
                    id="unselect_all"><?php echo get_string('unselect_all', 'groupformation'); ?></span></div>
        </div>
        <div class="col_m_25 bp_align_right-middle">
            <?php foreach ($this->_['buttons'] as $button) { ?>
                <?php if ($button['type'] == 'submit'): ?>
                    <button id="<?php echo $button['id']; ?>" type="<?php echo $button['type']; ?>"
