...
<div class="grid bottom_stripe">
    ...
    <div class="col_s_25 bp_align_right-middle"><a href="<?php echo $entry['grouplink'][0]; ?>"><button class="gf_button gf_button_pill gf_button_tiny" <?php echo $entry['grouplink'][1]; ?> >zur Moodle Gruppenansicht</button></a></div>
