...
<div class="grid row_highlight">
    <div class="col_m_100">Es <?php echo ($this->_['statistics_processed']==1)?"hat":"haben"?> <b><?php echo $this->_['statistics_processed']; ?></b> <?php echo ($this->_['statistics_processed']==1)?"Studierender":"Studierende"?> den Fragebogen bearbeitet.</div>
<!--     <div class="col_m_12-5 bp_align_right-middle"><button class="gf_button gf_button_pill gf_button_tiny">view</button></div> -->
</div>
<div class="grid row_highlight">
...
<div class="grid row_highlight">
    <div class="col_m_100">Es gibt derzeit <b><?php echo $this->_['statistics_submited_complete']; ?></b> vollst&auml;ndig beantwortete Frageb&ouml;gen.</div>
